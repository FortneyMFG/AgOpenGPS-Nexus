...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CommandModuleContext"/> class.
    /// </summary>
    ...
    public CommandModuleContext(RootCommand rootCommand, IServiceProvider services, Option? outputOption = null)
    {
