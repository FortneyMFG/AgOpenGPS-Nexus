...
| map_canvas | OpenGL Map Canvas | core.map_canvas.v1 | shell.map | Refer to docs/development/SRS/references/aog-v6-mapping-brief.md for overlay breakdown. | Placeholder host remains; map canvas wiring tracked under NX-412 follow-up. |
