...
=======
- Meets yield layer metadata expectations in §08 Data Model & Storage (R-DATA-045).【F:docs/SRS/sections/3X/32_Persistence_Formats.md†L33-L34】
- Powers analytics overlays and legends referenced by R-FE-074 in §05 Frontends.【F:docs/SRS/sections/9X/91_UI_Shell_Layout.md†L29-L30】
- Documents plugin APIs consumed by §12 Extensibility for analytics and export hooks.【F:docs/SRS/sections/9X/94_Extensibility_Packaging_Updates.md†L18-L36】
>>>>>>> origin/develop
