...
- **Scope:** Stand up the per-section layer controller pipeline that normalizes sensor feeds, maintains running accumulators, and emits immutable snapshots so PoseStream, SectionState, and TileStore stay consistent during live runs and replays.【F:docs/SRS/sections/04_Backend_Services.md†L6-L18】【F:docs/SRS/options/O-BACKEND-4_LayerControllers.md†L1-L38】
- **Key decisions:** Controller lifecycle (ingest → aggregate → emit), concurrency boundaries between IO, aggregation, and rendering threads, schema hashing/registry handshake with layer definitions, and how controllers surface quality/`rateNA` metadata into dashboards and exports.【F:docs/SRS/options/O-BACKEND-4_LayerControllers.md†L7-L21】【F:docs/SRS/options/O-DATA-5_MetadataDrivenLayers.md†L6-L28】【F:docs/SRS/options/O-TEST-4_LayerReplayCI.md†L6-L19】
- **SRS alignment:** Backend Services (§04 controllers & health budgets), Data Model (§08 layer storage & metadata), Telemetry (§10 diagnostics), Testing (§11 replay determinism).【F:docs/SRS/sections/04_Backend_Services.md†L6-L18】【F:docs/SRS/sections/08_Data_Model_Storage.md†L6-L21】【F:docs/SRS/sections/10_Telemetry_Health.md†L12-L18】【F:docs/SRS/sections/11_Testing_CI_CDPipelines.md†L6-L19】
- **Primary requirements:** R-BE-010…R-BE-013; R-DATA-010…R-DATA-018; R-TH-020; R-CI-010…R-CI-030.【F:docs/SRS/sections/04_Backend_Services.md†L11-L15】【F:docs/SRS/sections/08_Data_Model_Storage.md†L11-L21】【F:docs/SRS/sections/10_Telemetry_Health.md†L13-L18】【F:docs/SRS/sections/11_Testing_CI_CDPipelines.md†L11-L19】
- **Tasks:** Implement controller abstractions, DI registry, and buffer pools; wire PoseStream ingestion and replay harnesses; expose quality/diagnostic feeds; update TileStore writers; extend CI with deterministic replay fixtures covering 48–64 row rigs.【F:docs/SRS/options/O-BACKEND-4_LayerControllers.md†L7-L34】【F:docs/SRS/options/O-TEST-4_LayerReplayCI.md†L6-L19】
- **Acceptance hooks:** Golden replay comparisons for controller outputs, per-layer CPU/memory budget checks, schema hash validation during layer registration, and regression tests proving binary coverage parity.【F:docs/SRS/options/O-TEST-4_LayerReplayCI.md†L6-L24】【F:docs/SRS/options/O-BACKEND-4_LayerControllers.md†L27-L34】
...
- **Primary requirements:** R-CTRL-000…R-CTRL-007; R-GEO-000…R-GEO-002; R-EXT-120.【F:docs/SRS/sections/09_Control_Automation.md†L16-L24】【F:docs/SRS/sections/07_Interprocess_API.md†L16-L24】【F:docs/SRS/sections/12_Extensibility_Plugins.md†L21-L28】
- **Tasks:** Publish guidance lane/turn schemas, port Stanley/pure-pursuit control with deterministic fixtures, integrate constraint-aware lookahead, define plugin hooks for lane publishing, and ensure autosteer outputs respect Core arbitration leases.【F:docs/porting/V6-Inventory.md†L7-L19】【F:docs/ADR/ADR-027-spatial-constraints.md†L7-L44】【F:docs/SRS/sections/09_Control_Automation.md†L16-L24】
- **Acceptance hooks:** Replay suite comparing guidance paths against legacy traces, constraint gate fault-injection scenarios, operator UX tests for turn previews, and firmware loop validation with logged pose/control deltas.【F:docs/porting/V6-Inventory.md†L51-L54】【F:docs/ADR/ADR-027-spatial-constraints.md†L44-L108】
...
- **Primary requirements:** R-FE-010…R-FE-014; R-FE-040…R-FE-042; R-FE-030…R-FE-032; R-TH-020.【F:docs/SRS/sections/05_Frontends.md†L10-L33】【F:docs/SRS/sections/10_Telemetry_Health.md†L12-L18】
- **Tasks:** Refactor map overlays and dashboards to read layer metadata, implement inspector/legend components, ship preset catalogs and configuration tooling, and wire feature flags plus replay benchmarks for 48–64 row rigs.【F:docs/SRS/options/O-UI-5_MetadataDrivenDashboards.md†L6-L28】【F:docs/SRS/options/O-UI-5_MetadataDrivenDashboards.md†L25-L36】【F:docs/SRS/options/O-TEST-4_LayerReplayCI.md†L6-L19】
- **Acceptance hooks:** UI automation covering metadata-driven widgets, performance profiling against replay fixtures, feature-flag rollout docs, and compatibility checks for companion/remote modes honoring the same metadata contracts.【F:docs/SRS/options/O-TEST-4_LayerReplayCI.md†L6-L24】【F:docs/SRS/options/O-UI-5_MetadataDrivenDashboards.md†L25-L36】
