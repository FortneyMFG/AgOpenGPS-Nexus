...
- Remote dashboards default to monitor-only; plugins must not escalate permissions without an operator-approved lease, aligning with development/SRS §09 safety posture.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L33-L60】
...
1. Update or reference relevant ADRs/development/SRS sections.
