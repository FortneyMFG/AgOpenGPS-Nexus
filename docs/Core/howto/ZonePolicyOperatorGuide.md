...
[ADR-027 — Spatial constraints & zone policies](../../development/SRS/sections/7X_Mapping_Geospatial/72-ADR-027 - Spatial Constraints & Zone Policies.md) and the UI
...
[SRS control & automation section](../../development/SRS/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md) for the underlying
