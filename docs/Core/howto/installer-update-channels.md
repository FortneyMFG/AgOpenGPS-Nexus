...
operation.【F:docs/Core/howto/windows-packaging.md†L14-L58】
...
2. For the ZIP path, stop Nexus, back up the previous folder, and extract the new
   ...
   starts.【F:docs/Core/howto/windows-packaging.md†L14-L58】
3. For the installer bundle, extract `AgOpenGPS.Nexus-win-x64-installer.zip`, run
   ...
   Start Menu shortcuts.【F:docs/Core/howto/windows-packaging.md†L41-L58】
