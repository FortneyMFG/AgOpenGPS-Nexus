...
- **Renderer cache alignment.** `WeatherOverlay.v1` surfaces `x-nexus-layerIds`
  ...
  conventions, matching ADR-011 guidance.【F:schemas/WeatherOverlay.v1.json†L1-L36】【F:docs/development/SRS/sections/9X_Frontends_Ops/91-ADR-011 - Mapping and visualization imagery pipeline.md†L1-L52】
- **Fusion provenance.** Weather overlays participate in prescription fusion
  ...
  same dataset fed ADR-013 derivations.【F:schemas/examples/WeatherOverlay.sample.json†L1-L31】【F:docs/development/SRS/sections/3X_Data_Storage/32-ADR-013 - Derived products and prescription analytics.md†L11-L42】

## References
- [ADR-011 — Mapping & Imagery Visualization](../../development/SRS/sections/9X_Frontends_Ops/91-ADR-011 - Mapping and visualization imagery pipeline.md)
- [ADR-053 — Weather Plugin](../../development/SRS/sections/7X_Mapping_Geospatial/72-ADR-053 - Weather & Environment Plugin.md)
