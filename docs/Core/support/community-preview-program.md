...
[installer/update channel guide](../../development/howto/installer-update-channels.md) so preview machines
...
- **Opt-in portal** — Dealers and advanced operators enrol through the dealer toolkit, selecting
  ...
  [multi-machine sync workflow](../multi-machine-sync.md) to keep preview rigs aligned
...
- **Weekly survey** — Participants receive a short survey summarising changes and capturing
  ...
  [multi-machine synchronization workflow](../multi-machine-sync.md).
