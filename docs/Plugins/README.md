...
Nexus plugins extend Core, AgIO, and the UI through manifest-driven
capabilities. Start here for architecture notes, contribution guidance,
and the official plugin catalogue.

## Quick Links

- [Plugin architecture](architecture.md)
- [Manifest governance](plugin-lease-manifest-governance.md)
- [Dependency map](nexus-plugin-dependency-map.md)
- [Security guidelines](security.md)
- [Performance guardrails](performance.md)
- [Official plugin catalogue](official/README.md)
- [Plugin briefs](briefs/README.md)
- [Plugin tutorials](tutorials/first-plugin.md)
- [Fixtures](fixtures/README.md)

Cross-check plugin requirements in the [SRS extensibility slice](../development/SRS/sections/9X_Frontends_Ops/)
and pair changes with the [developer guide](../development/README.md) for
...
- Package plugins as ZIP archives containing binaries, manifests, and optional assets. The root manifest (`plugin.manifest.json`)
  must declare capabilities, layer definitions, required ADR alignment, and signature metadata.
...
- Remote dashboards default to monitor-only; plugins must not escalate permissions without an operator-approved lease, aligning with SRS §09 safety posture.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L33-L60】
- Multi-machine data sharing must respect share/subscribe profiles. Sensitive topics (layer edits, profitability) remain opt-in.【F:docs/Plugins/briefs/MultiMachine.md†L1-L80】
