...
- Load session-scoped logs generated by Telemetry Logging, hydrating context (`farmId`, `seasonId?`, `jobId`, `sessionId`, `fieldIds[]`) before starting playback.【F:docs/development/SRS/sections/6X_Core_Domain_Services/62-ADR-041 - Job Sessions Lifecycle.md†L55-L73】【F:docs/Plugins/TelemetryLogging.md†L1-L80】
