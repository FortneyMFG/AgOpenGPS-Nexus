...
- Emit telemetry tagged with `sessionId` so analytics can correlate steering performance with specific outings.【F:docs/development/SRS/sections/6X_Core_Domain_Services/62_Job_Lifecycle.md†L59-L92】
