...
This tutorial walks through creating a basic Nexus plugin. For detailed requirements, see [ADR-018: Plugin API](../../development/SRS/sections/9X_Frontends_Ops/94-ADR-018 - Plugin API Capability Discovery and Runtime Model.md) and [Plugin Requirements](../../development/SRS/sections/9X_Frontends_Ops/94_Extensibility_Packaging_Updates.md).
...
- [Plugin architecture reference](../architecture.md)
- [Plugin Security Guide](../security.md)
- [Testing Guidelines](../../development/testing.md)
- [Performance Guidance](../../development/performance.md)
