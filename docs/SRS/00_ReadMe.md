...
| R-UI-007 | O-UI-2, O-UI-5, O-UI-7 | [Accessibility presets](sections/9X/91_UI_Shell_Layout.md) | ADR-UI-007 (TBD) |
...
| R-COMM-012 | O-COMM-2, O-COMM-6, O-COMM-7 | [Latency budgets](sections/4X/42_Transports.md) | ADR-COMM-006 (TBD) |
| R-COMM-013 | O-COMM-2, O-COMM-6, O-COMM-7 | [Security slice](sections/9X/95_Security_Permissions.md) | ADR-COMM-006 (TBD) |
...
| R-BE-013 | O-BE-6, O-BE-7 | [Service health targets](sections/2X/21_System_Decomposition_Boundaries.md) | ADR-BE-006 (TBD) |
| R-BE-014 | O-BE-6, O-BE-7 | [Fail-safe expectations](sections/2X/21_System_Decomposition_Boundaries.md) | ADR-BE-006 (TBD) |
...
| R-FE-013 | O-FE-6, O-FE-7 | [Safety posture notes](sections/9X/91_UI_Shell_Layout.md) | ADR-FE-005 (TBD) |
| R-FE-014 | O-FE-5 | [Training & presets](sections/9X/91_UI_Shell_Layout.md) | ADR-FE-006 (TBD) |
...
| R-HW-006 | O-HW-5 | [Capability discovery](sections/5X/51_Sensor_Actuator_Abstractions.md) | ADR-HW-006 (TBD) |
| R-HW-012 | O-HW-5 | [ISOBUS reference](references/ISOBUS_Section_Control.md) | ADR-HW-007 (TBD) |
| R-HW-013 | O-HW-5, O-HW-6 | [Safety interlocks](sections/5X/51_Sensor_Actuator_Abstractions.md) | ADR-HW-008 (TBD) |
| R-HW-014 | O-HW-5, O-HW-6 | [Certification placeholders](sections/5X/51_Sensor_Actuator_Abstractions.md) | ADR-HW-008 (TBD) |
...
| R-API-003 | O-API-1, O-API-3 | [Schema policy](sections/4X/41_Inter_Application_API.md) | ADR-API-003 (TBD) |
...
| R-API-005 | O-API-6 | [Handshake notes](sections/4X/41_Inter_Application_API.md) | ADR-API-006 (TBD) |
| R-API-012 | O-API-5, O-API-6 | [Release management policy](sections/4X/41_Inter_Application_API.md) | ADR-API-007 (TBD) |
...
| R-DATA-003 | O-DATA-0, O-DATA-5 | [Export formats](sections/3X/32_Persistence_Formats.md) | ADR-DATA-003 (TBD) |
...
| R-DATA-004 | O-DATA-5 | [Compression ideas](sections/3X/32_Persistence_Formats.md) | ADR-DATA-006 (TBD) |
| R-DATA-013 | O-DATA-5 | [Retention policy](sections/3X/32_Persistence_Formats.md) | ADR-DATA-007 (TBD) |
| R-DATA-014 | O-DATA-5 | [Schema hashes](sections/3X/32_Persistence_Formats.md) | ADR-DATA-007 (TBD) |
| R-DATA-026 | O-DATA-5 | [Spatial constraints](sections/3X/32_Persistence_Formats.md) | [ADR-027](../ADR/ADR-027-spatial-constraints.md) |
| R-DATA-027 | O-DATA-5 | [Buffered footprints](sections/3X/32_Persistence_Formats.md) | [ADR-027](../ADR/ADR-027-spatial-constraints.md) |
| R-DATA-028 | O-DATA-5 | [Indexed queries](sections/3X/32_Persistence_Formats.md) | [ADR-027](../ADR/ADR-027-spatial-constraints.md) |
| R-DATA-040 | O-DATA-5 | [Zone edit provenance](sections/3X/32_Persistence_Formats.md) | [ADR-044](../ADR/ADR-044_ZoneDrawingFramework.md) |
| R-DATA-041 | O-DATA-5 | [Crop history schema](sections/3X/32_Persistence_Formats.md) | [ADR-045](../ADR/ADR-045_CropTypePlugin.md) |
| R-DATA-042 | O-DATA-5 | [Session weather snapshot](sections/3X/32_Persistence_Formats.md) | [ADR-053](../ADR/ADR-053_WeatherPlugin.md) |
| R-DATA-043 | O-DATA-5 | [Plugin attribute schemas](sections/3X/32_Persistence_Formats.md) | [ADR-044](../ADR/ADR-044_ZoneDrawingFramework.md) |
| R-DATA-044 | O-DATA-5 | [Genetics records](sections/3X/32_Persistence_Formats.md) | [ADR-046](../ADR/ADR-046_GeneticsPlugin.md) |
| R-DATA-045 | O-DATA-5 | [Yield layers](sections/3X/32_Persistence_Formats.md) | [ADR-049](../ADR/ADR-049_YieldPlugin.md) |
| R-DATA-046 | O-DATA-5 | [Cost & profit schemas](sections/3X/32_Persistence_Formats.md) | [ADR-050](../ADR/ADR-050_CostProfitPlugin.md) |
| R-DATA-047 | O-DATA-5 | [Risk overlays](sections/3X/32_Persistence_Formats.md) | [ADR-052](../ADR/ADR-052_FieldHealthPlugin.md) |
| R-DATA-048 | O-DATA-5 | [Weather overlays](sections/3X/32_Persistence_Formats.md) | [ADR-053](../ADR/ADR-053_WeatherPlugin.md) |
| R-DATA-049 | O-DATA-5 | [Report templates](sections/3X/32_Persistence_Formats.md) | [ADR-051](../ADR/ADR-051_ReportBuilder.md) |
| R-DATA-050 | O-DATA-5 | [Inventory ledger](sections/3X/32_Persistence_Formats.md) | [ADR-050](../ADR/ADR-050_CostProfitPlugin.md) |
| R-DATA-051 | O-DATA-5 | [Inventory provenance](sections/3X/32_Persistence_Formats.md) | [ADR-050](../ADR/ADR-050_CostProfitPlugin.md) |
...
| R-MM-002 | O-MM-2 | [Headless plans](sections/6X/61_Kinematics_Pose_Fusion.md) | ADR-MM-002 (TBD) |
| R-MM-003 | O-MM-2, O-OS-5 | [Linux Core option](options/2X/O-BACKEND-6_LinuxCoreService.md) | ADR-MM-003 (TBD) |
| R-MM-004 | O-MM-2 | [Layout locking](sections/6X/61_Kinematics_Pose_Fusion.md) | ADR-MM-004 (TBD) |
| R-MM-005 | O-MM-2 | [Auto-recovery expectations](sections/6X/61_Kinematics_Pose_Fusion.md) | ADR-MM-005 (TBD) |
...
| R-TH-003 | O-TH-3 | [Telemetry feeds](sections/6X/64_Telemetry_Health.md) | ADR-TH-003 (TBD) |
...
| R-TH-005 | O-TH-3 | [Health scoring](sections/6X/64_Telemetry_Health.md) | ADR-TH-006 (TBD) |
| R-TH-012 | O-TH-3 | [Governance policies](sections/6X/64_Telemetry_Health.md) | ADR-TH-007 (TBD) |
...
| R-CI-002 | O-CI-0 | [Linting ideas](sections/9X/96_Quality_Engineering_Release.md) | ADR-CI-002 (TBD) |
| R-CI-003 | O-CI-1 | [Packaging criteria](sections/9X/96_Quality_Engineering_Release.md) | ADR-CI-003 (TBD) |
...
| R-CI-005 | O-CI-4 | [Hardware-in-loop](sections/9X/96_Quality_Engineering_Release.md) | ADR-CI-006 (TBD) |
| R-CI-012 | O-CI-3 | [Release assurance](sections/9X/96_Quality_Engineering_Release.md) | ADR-CI-007 (TBD) |
| R-CI-013 | O-CI-4 | [Fixture governance](sections/9X/96_Quality_Engineering_Release.md) | ADR-CI-007 (TBD) |
...
| R-EXT-002 | O-EXT-1, O-EXT-3, O-EXT-5 | [Plugin boundary](sections/9X/94_Extensibility_Packaging_Updates.md) | ADR-EXT-002 (TBD) |
| R-EXT-003 | O-EXT-1, O-EXT-3, O-EXT-5 | [Templates](sections/9X/94_Extensibility_Packaging_Updates.md) | ADR-EXT-002 (TBD) |
| R-EXT-010 | O-EXT-3, O-EXT-5 | [Layer controllers](options/6X/O-BACKEND-4_LayerControllers.md) | ADR-EXT-003 (TBD) |
| R-EXT-004 | O-EXT-1 | [Sandboxing notes](sections/9X/94_Extensibility_Packaging_Updates.md) | ADR-EXT-004 (TBD) |
| R-EXT-011 | O-EXT-3, O-EXT-5 | [Governance requirements](sections/9X/94_Extensibility_Packaging_Updates.md) | ADR-EXT-005 (TBD) |
| R-PKG-000 | Workstream TBD | [Packaging flow](sections/9X/94_Extensibility_Packaging_Updates.md#packaging-updates--catalog) | ADR-PKG-001 (TBD) |
| R-PKG-005 | Workstream TBD | [Permission prompts](sections/9X/94_Extensibility_Packaging_Updates.md#packaging-updates--catalog) | ADR-PKG-002 (TBD) |
...
| R-SEC-002 | O-SEC-2 | [Role guidance](sections/9X/95_Security_Permissions.md) | ADR-SEC-002 (TBD) |
| R-SEC-003 | O-SEC-1 | [Secrets plan](sections/9X/95_Security_Permissions.md) | ADR-SEC-003 (TBD) |
| R-SEC-004 | O-SEC-3 | [Linux Core option](options/2X/O-BACKEND-6_LinuxCoreService.md) | ADR-SEC-004 (TBD) |
| R-SEC-005 | O-SEC-3 | [Audit logging](sections/9X/95_Security_Permissions.md) | ADR-SEC-005 (TBD) |
| R-SEC-006 | O-SEC-1, O-SEC-4 | [Secrets migration](sections/9X/95_Security_Permissions.md) | ADR-SEC-006 (TBD) |
| R-SEC-007 | O-SEC-3 | [Audit readiness](sections/9X/95_Security_Permissions.md) | ADR-SEC-006 (TBD) |
...
| R-UPD-002 | O-UPD-2, O-UPD-4 | [Rollback guidance](sections/3X/33_Offline_First_Sync.md) | ADR-UPD-002 (TBD) |
| R-UPD-003 | O-UPD-5 | [Staged updates](sections/3X/33_Offline_First_Sync.md) | ADR-UPD-003 (TBD) |
| R-UPD-004 | O-UPD-5 | [Linux Core option](options/2X/O-BACKEND-6_LinuxCoreService.md) | ADR-UPD-004 (TBD) |
| R-UPD-005 | O-UPD-1 | [Background updates](sections/3X/33_Offline_First_Sync.md) | ADR-UPD-005 (TBD) |
| R-UPD-006 | O-UPD-5 | [Validation checklist](sections/3X/33_Offline_First_Sync.md) | ADR-UPD-006 (TBD) |

### Section 74 — Monitoring Systems
| Requirement | Options / Workstreams | References & tooling | ADR placeholder |
|-------------|----------------------|----------------------|-----------------|
| R-GA-000 | Workstream TBD | [Gauge mappings](sections/7X/74_Monitoring_Systems.md) | ADR-GA-001 (TBD) |
| R-GA-001 | Workstream TBD | [Gauge telemetry PGNs](options/4X/O-COMM-7_GaugeTelemetryPGNs.md) | ADR-GA-002 (TBD) |
| R-GA-002 | Workstream TBD | [Gauge configuration JSON](sections/7X/74_Monitoring_Systems.md) | ADR-GA-003 (TBD) |
| R-GA-003 | Workstream TBD | [Gauge UI behaviors](sections/7X/74_Monitoring_Systems.md) | ADR-GA-004 (TBD) |
| R-GA-004 | Workstream TBD | [Smoothing rules](sections/7X/74_Monitoring_Systems.md) | ADR-GA-005 (TBD) |
| R-GA-005 | Workstream TBD | [Gauge capability discovery](sections/7X/74_Monitoring_Systems.md) | ADR-GA-006 (TBD) |

### Section 55 — Firmware Interfaces & Updates
| Requirement | Options / Workstreams | References & tooling | ADR placeholder |
|-------------|----------------------|----------------------|-----------------|
| DFU-001 | Workstream TBD | [Identity discovery](sections/5X/55_Firmware_Interfaces_Updates.md) | ADR-DFU-001 (TBD) |
| DFU-004 | Workstream TBD | [Update orchestration](sections/5X/55_Firmware_Interfaces_Updates.md) | ADR-DFU-002 (TBD) |
| DFU-008 | Workstream TBD | [Offline bundles](sections/5X/55_Firmware_Interfaces_Updates.md) | ADR-DFU-003 (TBD) |

### Section 93 — Command Line Interface
| Requirement | Options / Workstreams | References & tooling | ADR placeholder |
|-------------|----------------------|----------------------|-----------------|
| R-CLI-000…R-CLI-003 | O-CLI-0 | [Unified host requirements](sections/9X/93_Command_Line_Interface.md) | ADR-054 (TBD) |
| R-CLI-004…R-CLI-007 | O-CLI-0 | [CLI UX & config discovery notes](sections/9X/93_Command_Line_Interface.md) | ADR-054 (TBD) |
| R-CLI-008…R-CLI-010 | O-CLI-0 | [Versioning & packaging requirements](sections/9X/93_Command_Line_Interface.md) | ADR-054 (TBD) |
