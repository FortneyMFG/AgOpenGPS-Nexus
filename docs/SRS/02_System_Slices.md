...
| 08A | [CM5 Integrated Controller](sections/08A_CM5_Integrated_Controller.md) | Deterministic fast-path control when NAV, steer-ctrl, and AgIO co-reside on CM5 hardware. | Builds on 03A transports and 06 hardware I/O; authority flow informs 09 automation and 10 telemetry.
