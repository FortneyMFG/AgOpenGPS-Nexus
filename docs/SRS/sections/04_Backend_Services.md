...
- R-BE-010 (MUST, proposed-variable-layer): Introduce per-section layer controllers that normalize inputs, aggregate overlap math, and expose quality metrics while keeping binary coverage intact.【F:docs/SRS/options/O-BACKEND-4_LayerControllers.md†L1-L28】
