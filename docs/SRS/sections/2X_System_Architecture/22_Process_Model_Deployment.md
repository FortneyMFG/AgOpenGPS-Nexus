...
Describe supported process layouts and deployment patterns for Nexus so critical guidance loops stay deterministic while enabling remote clients and analytics workloads.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L42-L128】【F:docs/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L13-L76】
...
|--------------|-----------------|-----------------------|---------------------------|--------------------|
| Hosting Model | Single executable hosts UI, Core, and AgIO. | Blocks remote displays and Linux pilots. | Introduce Core daemon with gRPC bridge. | 【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L42-L128】 |
...
| Recovery | UI reboot restarts everything. | No health policy or watchdog separation. | systemd/service watchdogs with telemetry endpoints. | 【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L78-L128】 |
...
| R-PROC-001 | SHOULD | Split Core | Provide out-of-process Core service with gRPC/IPC bindings. | Linux Core proposal | UI reconnect latency ≤500 ms during Core restarts.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L78-L128】 |
...
- Headless deployments MUST expose gRPC + WebSocket APIs consistent with §21 options.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L42-L128】
...
|----|-------------|--------|---------------------|-------|
| RISK-22-1 | Network partitions interrupt remote client command loops. | High | Enforce reconnect budgets and offline fallbacks defined for Core service APIs.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L78-L128】 | @deployment-wg |
...
| C2 | Split Core service boundary | Support out-of-process Core daemon with deterministic timing and health endpoints to unlock Linux deployments.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L42-L128】 |
| C3 | Remote & containerized clients | Provide network-friendly topologies and packaging for remote tablets and managed fleets while respecting timing budgets.【F:docs/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L33-L126】 |
...
Maintain LocalInProc for legacy rigs while investing in LocalOutOfProc and RemoteClient topologies to unlock Linux deployments and multi-display scenarios; containerized stack provides managed fleet story.【F:docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md†L42-L128】
...
| R-PROC-001 | LocalOutOfProc, RemoteClient, C2 | 21-ADR-028 | `tests/integration/ipc_reconnect.md` | `docs/SRS/sections/2X_System_Architecture/21-ADR-028 - Nexus stack responsibilities & handoff boundaries.md` |
