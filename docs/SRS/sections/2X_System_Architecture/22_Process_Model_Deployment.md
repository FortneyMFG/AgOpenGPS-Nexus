...
- R-PROC-003 (MUST, container/headless): Ship container manifests (Docker/Podman) for Core + AgIO + telemetry sinks so farms can host Nexus as a managed service with OTA updates.【F:SRS/Sections/1X_Platform_Foundations/11_OS_Support.md†L14-L45】
