...
## Problem statement
Define how Nexus components split across processes, containers, and devices so guidance-critical workloads stay responsive while enabling remote clients and cloud-assisted analytics.【F:docs/SRS/sections/2X_System_Architecture/21-O6%20-%20Linux%20Core%20service%20with%20remote%20frontends.md†L1-L44】【F:docs/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L13-L76】
...
- R-PROC-001 (SHOULD, split-core): Provide an out-of-process Core service with gRPC/IPC bindings so UI shells and headless agents can run on separate processes or hardware without duplicating business logic.【F:docs/SRS/sections/2X_System_Architecture/21-O6%20-%20Linux%20Core%20service%20with%20remote%20frontends.md†L1-L44】
...
## Current sentiment
The community favors a hybrid approach: keep LocalInProc for legacy rigs while investing in LocalOutOfProc and RemoteClient topologies that unlock Linux deployments and remote displays without fragmenting the codebase.【F:docs/SRS/sections/2X_System_Architecture/21-O6%20-%20Linux%20Core%20service%20with%20remote%20frontends.md†L1-L44】【F:docs/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L33-L95】
