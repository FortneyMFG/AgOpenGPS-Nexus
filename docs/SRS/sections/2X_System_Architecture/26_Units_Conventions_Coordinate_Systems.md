...
Establish global policies for units, coordinate reference systems (CRS), timestamps, and orientation conventions. The section anchors cross-cutting assumptions so Core services, transports, and UI surfaces exchange data without repeated unit negotiations or conflicting CRS decisions.【F:docs/SRS/references/crs-normalization-matrix.md†L1-L74】
