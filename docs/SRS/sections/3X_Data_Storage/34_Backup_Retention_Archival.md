...
| R-BACKUP-001 | MUST | Backup Targets | Support scheduled exports to removable media and network shares (SMB/NFS/S3) with resumable uploads and checksum verification.【F:docs/SRS/sections/3X_Data_Storage/33_Offline_First_Sync.md†L16-L124】【F:docs/SRS/sections/2X_System_Architecture/21_System_Decomposition_Boundaries.md†L24-L44】 |
