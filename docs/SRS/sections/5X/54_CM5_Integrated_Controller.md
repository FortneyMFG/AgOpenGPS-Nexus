# 54 — CM5 Integrated Controller (Status: drafting requirements)
...
- R-CM5-003 (MUST, scheduling): Run steer-ctrl and Pumpkin Pi with real-time
  ...
  service configuration for CM5 images.【F:docs/SRS/sections/5X_Hardware_IO_Device_Layer/53_AOG_Link_Compatibility.md†L330-L341】【F:docs/AgIO/cm5.md†L6-L33】
- R-CM5-004 (SHOULD, MCU coexistence): Allow external MCUs to observe fast-path
  ...
  without schema changes, relying on authority tokens for arbitration.【F:docs/SRS/sections/5X_Hardware_IO_Device_Layer/53_AOG_Link_Compatibility.md†L308-L327】
...
- **Data paths:** Navigation publishes `SteerTarget` through shared memory first,
  ...
  fast-path frames via AgIO adapters.【F:docs/SRS/sections/5X_Hardware_IO_Device_Layer/53_AOG_Link_Compatibility.md†L300-L323】【F:docs/plugins/pumpkin-pi.md†L23-L44】
...
- [Section 53 — AOG-Link Compatibility](03A_AOG_Link_v1.md)
