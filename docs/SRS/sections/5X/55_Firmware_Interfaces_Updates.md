# 55 — Firmware Interfaces & Updates (Status: proposal)
...
- Transport discovery and PGN framing: see [Section 42 — Transports](03_Comm_Transports.md).
- Plugin surface and updater extensibility: see [Section 94 — Extensibility, Packaging & Updates](12_Extensibility_Plugins.md).
