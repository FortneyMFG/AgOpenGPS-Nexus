...
## Problem statement
Define the responsibilities, lifecycle, and hot-swap behavior for AgIO as the hardware integration host, especially when split from the desktop UI or deployed on CM5/Linux headless rigs.【F:docs/SRS/sections/5X_Hardware_IO_Device_Layer/51_Sensor_Actuator_Abstractions.md†L12-L116】【F:docs/SRS/options/2X/O-BACKEND-6_LinuxCoreService.md†L1-L44】
