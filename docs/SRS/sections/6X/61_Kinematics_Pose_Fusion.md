...
- R-MM-003 (SHOULD, proposed-LinuxCore): Deliver kiosk/headless launchers for the Linux Core + remote clients (auto-login, fullscreen) so rigs boot directly into an operator-ready view.【F:docs/SRS/options/2X/O-BACKEND-6_LinuxCoreService.md†L6-L23】【F:docs/SRS/options/9X/O-FRONT-6_RemoteClients.md†L10-L18】
...
- O-MM-5: Linux Core kiosk/headless deployment with remote frontends.【F:docs/SRS/options/2X/O-BACKEND-6_LinuxCoreService.md†L6-L44】【F:docs/SRS/options/9X/O-FRONT-6_RemoteClients.md†L1-L34】

### Equipment configuration primitives
- O-HW-7: Multi-steer equipment configurator primitives describe the module catalog, hitch rules, sensor attachments, mode profiles, calibration flows, telemetry surfaces, definition-of-done gates, and the axle-centric runtime graph that [ADR-017](../ADR/ADR-017-profiles-kinematics.md) consumes for articulated, tracked, or multi-axle rigs.【F:docs/SRS/options/5X/O-HW-7_MultiSteerConfigurator.md†L1-L420】
...
- The community wants kiosk scripts and watchdogs bundled with any Linux Core pilot so remote dashboards recover automatically after power loss.【F:docs/SRS/options/2X/O-BACKEND-6_LinuxCoreService.md†L6-L23】【F:docs/SRS/options/9X/O-FRONT-6_RemoteClients.md†L10-L34】
