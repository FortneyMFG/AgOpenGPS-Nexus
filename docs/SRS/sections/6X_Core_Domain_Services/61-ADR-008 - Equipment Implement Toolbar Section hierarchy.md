...
session provenance alignment with ADR-041.【F:docs/SRS/sections/6X_Core_Domain_Services/61-ADR-008 - Equipment Implement Toolbar Section hierarchy.md†L9-L31】
...
deterministically.【F:docs/SRS/sections/6X_Core_Domain_Services/61-ADR-008 - Equipment Implement Toolbar Section hierarchy.md†L13-L24】
...
* Session captures reference applied configurations so replay, profit, and genetics plugins
  align telemetry with actual hardware state.【F:docs/SRS/sections/6X_Core_Domain_Services/61-ADR-008 - Equipment Implement Toolbar Section hierarchy.md†L24-L38】
...
complex toolbar relationships or provide stable IDs for telemetry and replay consumers.【F:docs/SRS/sections/6X_Core_Domain_Services/61-ADR-008 - Equipment Implement Toolbar Section hierarchy.md†L9-L24】
...
* Configuration editor UX tests reject invalid overlap definitions and surface contextual guidance.【F:docs/SRS/sections/6X_Core_Domain_Services/61-ADR-008 - Equipment Implement Toolbar Section hierarchy.md†L40-L55】
