...
- R-LAY-002 (SHOULD, delta journals): Support delta-encoded journals with conflict resolution strategies (last-writer, merges) to reduce storage while preserving deterministic replay.【F:docs/SRS/sections/3X_Data_Storage/32_Persistence_Formats.md†L94-L156】【F:docs/SRS/options/9X/O-TEST-4_LayerReplayCI.md†L7-L44】
