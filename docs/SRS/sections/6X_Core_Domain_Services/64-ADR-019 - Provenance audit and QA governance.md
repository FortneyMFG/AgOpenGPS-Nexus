...
with session models, derived products, and persistence strategies.【F:docs/SRS/sections/6X_Core_Domain_Services/64-ADR-019 - Provenance audit and QA governance.md†L9-L16】
...
* Coordinate with session orchestration to ensure provenance relationships span jobs, PoseStreams, and derived artifacts.【F:docs/SRS/sections/6X_Core_Domain_Services/64-ADR-019 - Provenance audit and QA governance.md†L16-L27】
...
* CI pipelines incur hash computation overhead — mitigated by incremental hashing and caching strategies.【F:docs/SRS/sections/6X_Core_Domain_Services/64-ADR-019 - Provenance audit and QA governance.md†L27-L44】
...
* CI pipelines export signed JSON logs with ≤ 5% size overhead relative to raw event streams.【F:docs/SRS/sections/6X_Core_Domain_Services/64-ADR-019 - Provenance audit and QA governance.md†L44-L52】
