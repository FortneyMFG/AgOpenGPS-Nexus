...
maintainers, and remote dashboards across desktop, kiosk, and headless deployments.【F:docs/SRS/sections/6X_Core_Domain_Services/64_Telemetry_Health.md†L1-L116】
...
|--------------|-----------------|-----------------------|---------------------------|--------------------|
| Diagnostics UI | WinForms monitors for UDP/serial traffic and PGN inspection. | Manual workflows and limited automation. | Retain monitors while adding machine-readable telemetry feeds. | 【F:docs/SRS/sections/6X_Core_Domain_Services/64_Telemetry_Health.md†L7-L23】 |
| Health Endpoints | Ad hoc scripts for watchdogs and service restarts. | No standardized `/healthz` or structured logs. | Expose Linux Core health endpoints and structured logging. | 【F:docs/SRS/sections/6X_Core_Domain_Services/64_Telemetry_Health.md†L15-L21】 |
| Telemetry Coverage | Manual inspection of layer quality and packet rates. | Difficult to detect degradation early. | Provide layer-aware diagnostics and alerting. | 【F:docs/SRS/sections/6X_Core_Domain_Services/64_Telemetry_Health.md†L21-L32】 |
