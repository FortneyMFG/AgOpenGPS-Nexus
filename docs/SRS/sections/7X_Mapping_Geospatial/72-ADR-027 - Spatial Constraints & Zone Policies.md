...
### AgOpenGPS v6
- Field assets track boundaries and headlands through text exports (`Boundary.txt`, `Headland.txt`), and the WinForms runtime draws those polygons for lift cues, but there is no formal notion of keep-out or work-disabled zones beyond manual operator overrides.【F:docs/reference/agopen-v6/porting/V6-Functionality-Gap-Analysis.md†L16-L25】【F:docs/SRS/references/aog-v6-mapping-brief.md†L23-L34】
