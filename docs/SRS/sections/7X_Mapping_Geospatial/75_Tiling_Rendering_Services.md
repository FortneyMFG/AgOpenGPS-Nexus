...
- R-TILE-003 (MUST, headless rendering): Offer server-side rasterization/export paths (PNG/GeoTIFF) driven by the same rendering pipeline for report generation and offline sync dashboards.【F:docs/SRS/sections/9X_Frontends_Ops/91-O6%20-%20Remote%20gRPC-WebSocket%20clients%20backed%20by%20the%20Linux%20Core.md†L12-L34】【F:docs/SRS/sections/9X_Frontends_Ops/94_Extensibility_Packaging_Updates.md†L59-L120】
...
- R-TILE-005 (MUST, deterministic replay): Ensure tile updates replay deterministically from journals for CI/regression use cases.【F:docs/SRS/sections/9X_Frontends_Ops/96-O5%20-%20Replay-driven%20CI%20and%20rollout%20for%20layers.md†L7-L44】
