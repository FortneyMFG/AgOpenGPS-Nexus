...
- R-GEO-003 (SHOULD, data import/export): Enable custom import/export adapters that map to open formats while preserving provenance and schema version tags.【F:docs/SRS/options/7X/O-DATA-5_MetadataDrivenLayers.md†L32-L64】【F:docs/SRS/sections/3X_Data_Storage/32_Persistence_Formats.md†L94-L156】
