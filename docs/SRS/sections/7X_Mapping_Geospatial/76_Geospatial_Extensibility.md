...
- R-GEO-002 (MUST, edit tooling): Extend the shared LayerEditService to support custom geometry editors, attribute panels, and undo/redo semantics for plugin-defined layers.【F:docs/SRS/sections/7X_Mapping_Geospatial/72-ADR-044 - Zone Drawing Framework.md†L29-L74】【F:docs/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L90-L176】
...
## Current sentiment
Geospatial extensibility hinges on solid registry governance and shared editing tooling; contributors want ADR-022 precision policies and LayerEditService upgrades finalized before accepting third-party layer types into production builds.【F:docs/SRS/sections/3X_Data_Storage/32-ADR-022 - CRS units and precision policy.md†L1-L44】【F:docs/SRS/sections/7X_Mapping_Geospatial/71_Mapping_Kernel_Contracts.md†L92-L132】
