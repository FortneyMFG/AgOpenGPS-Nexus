...
- R-SEC-004 (SHOULD, proposed-LinuxCore): Run the Linux Core under a dedicated service account with least-privilege access to `/dev` devices and config directories, documenting how credentials are stored for remote clients.【F:docs/SRS/sections/2X_System_Architecture/21_System_Decomposition_Boundaries.md†L21-L44】
