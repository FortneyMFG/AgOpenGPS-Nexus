...
- O-CI-5: [Replay-driven CI and rollout for layers](../9X_Frontends_Ops/96-O5%20-%20Replay-driven%20CI%20and%20rollout%20for%20layers.md) — Deterministic datasets + feature-flagged deployment.
