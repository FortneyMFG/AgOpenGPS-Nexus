...
This folder captures the working guides for the Avalonia UI shell. Use it
to find layout conventions, lifecycle notes, and modernization plans.
...
when you extend or review UI behaviour.
