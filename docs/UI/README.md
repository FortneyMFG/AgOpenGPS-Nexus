...
[Section 91 — UI Shell & Layout](../development/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md)
and [ADR-034 Metadata Dashboards](../development/SRS/sections/9X_Frontends_Ops/91-ADR-034%20-%20Metadata-driven%20dashboards%20and%20inspector%20surfaces.md).
...
- **Shell roadmap:** [UI shell & plugin integration plan](../Core/reference/agvalonia/ui-shell-and-plugin-integration.md)
...
- **Styling governance:** The [metadata-driven UI style guide](metadata-driven-ui-style-guide.md)
  and [modernization prompt bundle](../Core/reference/agvalonia/ui-modernization-ai-prompts.md)
  document reusable assets and AI tooling for designers.
- **Phase workbooks:** Detailed plans for [Phase 3](../Core/reference/agvalonia/ui-phase3-job-field-lifecycle.md),
  [Phase 4](../Core/reference/agvalonia/ui-phase4-settings-hotkeys.md), and
  [Phase 5](ui-phase5-plugin-surfaces.md) surface acceptance criteria and
  plugin dependencies, while the
  [migration workbook](../Core/reference/agvalonia/ui-migration-workbook-phase0.md) inventories legacy assets.

## Directory map

- [`training/`](training/) — curated simulation presets and GA checklists that pair with the composite simulation fabric.
...
- [UI migration workbook](../Core/reference/agvalonia/ui-migration-workbook-phase0.md)
- [UI session lifecycle](ui-session-lifecycle.md)
- [Metadata-driven UI style guide](metadata-driven-ui-style-guide.md)
- [UI modernization prompt bundle](../Core/reference/agvalonia/ui-modernization-ai-prompts.md)
