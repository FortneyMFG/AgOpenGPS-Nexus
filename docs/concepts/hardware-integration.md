...
|----------|-----------|-----------|---------------|
| PGN V0 | UDP | Legacy AIO | [Legacy Protocol](../Core/reference/legacy-protocol.md) |
| AOG-Link V1 | Serial/CAN | Modern MCUs | [AOG-Link Spec](../Core/reference/aog-link-spec.md) |
| MQTT-SN | Network | Remote Devices | [MQTT Integration](../Core/reference/mqtt-integration.md) |
