...
This guide walks through setting up a Compute Module 5 or Raspberry Pi 5 deployment of Nexus. For detailed hardware requirements, see [OS Support Requirements](../../SRS/sections/01_OS_Support.md).
...
- [Hardware Requirements](../../SRS/sections/01_OS_Support.md)
