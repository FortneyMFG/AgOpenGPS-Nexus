...
| R-UI-004 | 9X Consideration C3 | — | `demos/ui/metadata-dashboard/` | `docs/development/SRS/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md#919-design-considerations` |
