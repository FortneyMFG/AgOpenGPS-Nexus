...
SRS §21 identifies the need for a composite simulation fabric where Core owns the authoritative clock, plugins publish to a shared bus, and hardware inputs can pre-empt simulated data without breaking determinism.【F:docs/development/SRS/sections/2X_System_Architecture/21_System_Decomposition_Boundaries.md†L1-L120】【F:docs/development/SRS/sections/9X_Frontends_Ops/94_Extensibility_Packaging_Updates.md†L17-L71】
Option 11-O1 aligns by positioning AgIO’s simulation backend alongside Windows and Linux backends using common contracts.【F:docs/development/SRS/sections/1X_Platform_Foundations/11-O1_Unified_DotNet8_Avalonia.md†L9-L47】
...
* Provides deterministic replay for CI and training scenarios.【F:docs/development/SRS/sections/2X_System_Architecture/23_Threading_Scheduling_Timing.md†L1-L120】
