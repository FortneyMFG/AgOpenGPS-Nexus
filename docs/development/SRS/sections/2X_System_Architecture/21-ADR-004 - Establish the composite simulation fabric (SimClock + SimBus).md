...
* Provides deterministic replay for CI and training scenarios.【F:docs/sections/2X_System_Architecture/23_Threading_Scheduling_Timing.md†L1-L120】
...
| - | Reformatted to ADR template; added governance details. | Nexus Team (Codex) |  |
