...
- Core persists immutable identifiers and authoring metadata for every entity, providing a stable anchor for synchronization, schema validation, and provenance reconciliation.【F:docs/development/SRS/sections/3X_Data_Storage/32_Persistence_Formats.md†L12-L156】
...
- Season organisers, job lifecycle services, and layer journaling depend on this hierarchy to coordinate multi-field work, cross-session analytics, and operator navigation flows.【F:docs/development/SRS/sections/3X_Data_Storage/31-ADR-040 - Season Organizers.md†L14-L104】【F:docs/development/SRS/sections/3X_Data_Storage/31-ADR-043 - Multi-Field Job Envelopes.md†L32-L121】【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-044 - Zone Drawing Framework.md†L29-L74】
...
| LayerEditEvent.v1 | Journal entry capturing deterministic layer edit provenance and undo/redo linkage.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-044 - Zone Drawing Framework.md†L29-L74】 |
...
| R-31005 | SHOULD | Navigation | UI flows SHOULD offer Season-first and Farm-first traversals backed by canonical hierarchy queries. | C6, ADR-040 | UX acceptance checklist; navigation integration tests.【F:docs/development/SRS/sections/3X_Data_Storage/31-ADR-040 - Season Organizers.md†L58-L104】 |
| R-31006 | MAY | Analytics | Cost, profit, genetics, and risk analytics MAY attach domain-specific facts using `extensions` while preserving Core-owned identifiers. | C7, ADR-050 | Plugin integration smoke tests verifying extensions do not mutate Core fields.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-050 - Cost & Profit Plugin.md†L21-L52】 |
...
- Identifiers MUST use lowercase slugs with ASCII-safe separators (`-`, `_`, `.`, `:`) for filesystem and URI safety.【F:docs/development/SRS/sections/3X_Data_Storage/31-ADR-043 - Multi-Field Job Envelopes.md†L58-L104】
- `fieldIds` MUST reference farms explicitly authorized for a job; cross-farm jobs require explicit envelopes defined in ADR-043.【F:docs/development/SRS/sections/3X_Data_Storage/31-ADR-043 - Multi-Field Job Envelopes.md†L32-L121】
...
- Sessions MUST maintain stable IDs to preserve layer provenance across edits and sync operations.【F:docs/development/SRS/sections/6X_Core_Domain_Services/62-ADR-041 - Job Sessions Lifecycle.md†L40-L92】
...
- [A1] PoseStream vector logs provide ≥ 25 Hz pose data referenced by sessions and layers.【F:docs/development/SRS/sections/3X_Data_Storage/32_Persistence_Formats.md†L30-L156】
- [A2] Network time synchronization keeps distributed rigs within ±50 ms, ensuring provenance timestamps remain ordered.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-044 - Zone Drawing Framework.md†L29-L74】
- [A3] Operators retain write access to job data directories required for journaling and sync tools.【F:docs/development/SRS/sections/3X_Data_Storage/32_Persistence_Formats.md†L121-L156】
...
- **LayerEditEvent.v1:** Immutable journal entries linking edits to jobs, sessions, and collaborative mesh replication.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-044 - Zone Drawing Framework.md†L29-L74】
...
- **GeneticsPlan.v1 / GeneticsVariety.v1:** Plugin-owned plan/actual layer schemas preserving provenance to jobs/sessions.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-046 - Genetics Plugin & Layers.md†L21-L66】
- **CostRecord.v1 / ProfitLayer.v1:** Financial extensions capturing expenses, revenues, and attribution.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-050 - Cost & Profit Plugin.md†L21-L52】
- **WeatherOverlay.v1:** Raster overlays referencing weather sources with plugin-owned value arrays.【F:docs/development/SRS/sections/7X_Mapping_Geospatial/72-ADR-053 - Weather & Environment Plugin.md†L21-L49】
