...
- **Normalization matrix.** [docs/Core/reference/crs-normalization-matrix.md](../Core/reference/crs-normalization-matrix.md)
...
- [Communications & transports requirements](../sections/4X_Interprocess_Communications/42_Transports.md)
