...
set by ADR-028.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L9-L28】
...
absent to guarantee deterministic fallbacks and telemetry signaling.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L12-L24】
...
* Telemetry and analytics gain opportunity/event tallies with traceable provenance.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L26-L40】
...
* Integration suites must expand fault-injection coverage (duplication, reordering,
  ±75 ms clock skew) — mitigated via CI automation.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L40-L52】
...
without excessive synchronization overhead.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L9-L28】
...
* Forced clock skew of ±25 ms must not break monotonic SectionState sequencing.【F:docs/development/SRS/sections/6X_Core_Domain_Services/61-ADR-007 - PoseStream and SectionState architecture.md†L32-L52】
