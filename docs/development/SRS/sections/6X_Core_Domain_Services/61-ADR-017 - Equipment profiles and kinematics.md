...
share a consistent foundation.【F:docs/sections/6X_Core_Domain_Services/61-ADR-017 - Equipment profiles and kinematics.md†L9-L21】
...
validation logic and deterministic JSON exports.【F:docs/sections/6X_Core_Domain_Services/61-ADR-017 - Equipment profiles and kinematics.md†L12-L24】
...
* Session snapshots reference applied profiles, providing provenance for replay and profit analytics.【F:docs/sections/6X_Core_Domain_Services/61-ADR-017 - Equipment profiles and kinematics.md†L24-L37】
...
* Profile editor unit tests validate deterministic export and schema conformance.【F:docs/sections/6X_Core_Domain_Services/61-ADR-017 - Equipment profiles and kinematics.md†L39-L48】
