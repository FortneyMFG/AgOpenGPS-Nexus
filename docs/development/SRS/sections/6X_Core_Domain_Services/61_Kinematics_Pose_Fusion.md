...
rig deployments.【F:docs/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L4-L82】
...
|--------------|-----------------|-----------------------|---------------------------|--------------------|
| Architecture | Multi-monitor helpers and discrete pose logs across AgOpenGPS, AgIO, and plugins. | Independent cadence assumptions break determinism and complicate automation gating. | Fuse pose timelines through PoseStream with deterministic diff ordering. | 【F:docs/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L8-L45】 |
| Performance | Manual layout recovery and ad hoc headless support. | Operators lose time recovering layouts; headless rigs lack watchdog policies. | Provide kiosk/headless launchers with watchdog recovery and remote dashboards. | 【F:docs/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L18-L42】 |
| UX / Config | Equipment grouping and overrides maintained through UI heuristics. | Overlapping SectionGroups lack deterministic arbitration rules. | Codify control graph priorities and override policies in Core arbitration. | 【F:docs/sections/6X_Core_Domain_Services/61_Kinematics_Pose_Fusion.md†L45-L74】 |
...
|--------|-------------------|---------------------|---------------------|
| R-MM-000 | UI regression | `tes../UI/MultiMonitorLayout.cs` | Windows remain anchored after move/restart cycles. |
...
|------|---------|--------|------------|
| 2025-10-20 | Initial rewrite using v0.1 template. | Nexus Team (Codex) |  |
...
|----------------|-------------------|--------|-----------------------|--------------------------|
| R-MM-000 | 61-O1 | 61-ADR-007 | `tes../UI/MultiMonitorLayout.cs` | `SourceCode/GPS/Helpers/ScreenHelper.cs` |
