...
and graph relationships tying jobs, equipment snapshots, PoseStreams, and derived outputs together.【F:docs/sections/6X_Core_Domain_Services/62-ADR-023 - Session and job model with provenance graph.md†L9-L20】
...
UI hooks for managing sessions, including integrity checks preventing orphaned references.【F:docs/sections/6X_Core_Domain_Services/62-ADR-023 - Session and job model with provenance graph.md†L20-L30】
...
* Crop and genetics metadata attaches directly to sessions for analytics alignment.【F:docs/sections/6X_Core_Domain_Services/62-ADR-023 - Session and job model with provenance graph.md†L30-L43】
...
* Provenance graph builder emits DAGs validated against schema, rejecting cycles and invalid attachments in integration tests.【F:docs/sections/6X_Core_Domain_Services/62-ADR-023 - Session and job model with provenance graph.md†L45-L55】
