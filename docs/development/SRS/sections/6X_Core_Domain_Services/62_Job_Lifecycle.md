...
consistent provenance and auditability.【F:docs/development/SRS/sections/6X_Core_Domain_Services/62_Job_Lifecycle.md†L4-L96】
...
|--------------|-----------------|-----------------------|---------------------------|--------------------|
| Lifecycle Control | Manual job/session toggles with limited provenance. | Resume flows rely on ad hoc caches and can lose context. | Formalize mount → session start ordering with deterministic events. | 【F:docs/development/SRS/sections/6X_Core_Domain_Services/62_Job_Lifecycle.md†L8-L61】 |
| Journaling | Autosave triggered by operator actions. | Crash recovery may replay incomplete batches inconsistently. | Define autosave cadence, journaling checkpoints, and deterministic recovery. | 【F:docs/development/SRS/sections/6X_Core_Domain_Services/62_Job_Lifecycle.md†L63-L74】 |
| Multi-field Support | Single-field focus with manual mounts. | Multi-field jobs require duplicated work. | Support mount/unmount APIs and provenance for multi-field workflows. | 【F:docs/development/SRS/sections/6X_Core_Domain_Services/62_Job_Lifecycle.md†L76-L88】 |
