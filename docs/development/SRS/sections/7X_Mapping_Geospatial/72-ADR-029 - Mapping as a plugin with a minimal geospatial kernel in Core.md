...
- Capability registration for `mapping:raster@v1`, `mapping:vector@v2`, and future
  ...
  dependency rules published in the manifest governance program.【F:docs/sections/9X_Frontends_Ops/94-ADR-031 - Official Plugin Bundle Dependency Governance.md†L17-L70】
- CRS normalization, tiling utilities, and replay taps shipped in Core must continue
  ...
  so controller pods can rely on deterministic pose/layer alignment.【F:docs/sections/4X_Interprocess_Communications/42_Transports.md†L6-L28】【F:docs/sections/3X_Data_Storage/32_Persistence_Formats.md†L10-L33】
- Mapping plugins that participate in spatial constraint enforcement remain bound to
  ...
  operator UX guidance in Section 5 of the SRS.【F:docs/sections/7X_Mapping_Geospatial/72-ADR-027 - Spatial Constraints & Zone Policies.md†L11-L64】【F:docs/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L44-L80】
...
- **Cons & mitigations:** IPC latency managed through shared monotonic timebase/frame IDs; protobuf version drift mitigated by contracts freeze/versioning; debugging supported by standardized replay taps; state fan-out handled via Core’s event bus and capability registry.【F:docs/sections/4X_Interprocess_Communications/42_Transports.md†L6-L28】【F:docs/sections/9X_Frontends_Ops/94-ADR-018 - Plugin API Capability Discovery and Runtime Model.md†L12-L34】
