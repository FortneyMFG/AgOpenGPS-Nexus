...
- Preset bundles must persist dependency graphs that align with the manifest
  ...
  states during orchestration.【F:docs/sections/9X_Frontends_Ops/94-ADR-031 - Official Plugin Bundle Dependency Governance.md†L15-L62】
- Layout inheritance and live-link semantics are now normative for UI pods; updates
  ...
  in the frontend SRS section.【F:docs/sections/9X_Frontends_Ops/91_UI_Shell_Layout.md†L22-L88】
- Task orchestration for preset application is officially bound to the JobsService
  ...
  metadata for auditing.【F:docs/sections/6X_Core_Domain_Services/62-ADR-030 - Field job sessions and lifecycle services.md†L20-L96】
