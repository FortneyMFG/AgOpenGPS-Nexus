...
- Plugin manifests declare additional gauges; governance and capability discovery align with ADR-031 and ADR-018.【F:docs/development/SRS/sections/9X_Frontends_Ops/94-ADR-031 - Official Plugin Bundle Dependency Governance.md†L19-L68】【F:docs/development/SRS/sections/9X_Frontends_Ops/94-ADR-018 - Plugin API Capability Discovery and Runtime Model.md†L19-L66】
...
| R-GA-003 | Visual regression | `tests/ui/GaugePalette.snap` | Widgets match reference colors and animations |
...
- Security policies in §95 enforce read-only scope for gauge subscribers; write access remains prohibited.【F:docs/development/SRS/sections/9X_Frontends_Ops/95_Security_Permissions.md†L31-L68】
...
- Confirm CLI telemetry commands output identical gauge metadata for automation pipelines.【F:docs/development/SRS/sections/9X_Frontends_Ops/93_Command_Line_Interface.md†L55-L86】
...
- Contributors emphasize deterministic replay to validate smoothing parameters before enabling new gauges by default.【F:docs/development/SRS/sections/9X_Frontends_Ops/96_Quality_Engineering_Release.md†L19-L74】
...
| R-GA-003 | C4 | — | `tests/ui/GaugePalette.snap` | UI Shell gauge components |
