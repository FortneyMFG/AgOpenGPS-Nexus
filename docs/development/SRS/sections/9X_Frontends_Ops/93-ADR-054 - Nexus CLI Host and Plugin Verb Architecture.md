...
## References
- [SRS Section 18 – Command Line Interface](../9X_Frontends_Ops/93_Command_Line_Interface.md)
- [SRS Section 16 – Plugin Packaging, Updates, and Catalog](../9X_Frontends_Ops/94_Extensibility_Packaging_Updates.md#packaging-updates--catalog)
