...
- Remote Core orchestration demands secure transport negotiation and offline-friendly operations for farm deployments.【F:docs/sections/9X_Frontends_Ops/94-ADR-018 - Plugin API Capability Discovery and Runtime Model.md†L19-L66】
...
| R-CLI-003 | MUST | Plugin Integration | Load `Nexus.Plugin.Cli.Abstractions` adapters or query plugin CLI reflection services without duplicating host logic. | ADR-018 capability discovery【F:docs/sections/9X_Frontends_Ops/94-ADR-018 - Plugin API Capability Discovery and Runtime Model.md†L19-L66】 | Plugin CLI integration harness |
...
- Operators request guided messaging when commands require elevated permissions or remote connectivity.【F:docs/sections/9X_Frontends_Ops/95_Security_Permissions.md†L31-L68】
