...
| R-SEC-004 | SHOULD | Linux Core Hardening | Run Linux Core under dedicated service account with least-privilege access; document credential storage for remote clients. | Linux Core ADR【F:docs/development/SRS/sections/2X_System_Architecture/21-O6 - Linux Core service with remote frontends.md†L21-L44】 | Systemd unit + credential audit |
...
- Linux Core adopters require documented service account hardening and credential policies.【F:docs/development/SRS/sections/2X_System_Architecture/21-O6 - Linux Core service with remote frontends.md†L21-L44】
