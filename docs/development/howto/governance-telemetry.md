...
3. **Review minutes** — Meeting notes stored as JSON files under
   `docs/development/SRS/sections/2X_System_Architecture/reviews/` are collated into the Markdown digest. Each entry can list
...
Each JSON file inside `docs/development/SRS/sections/2X_System_Architecture/reviews/` should follow this structure:
