...
- Manifest lint and capability export logs attached to the pull request per the
  [Plugin Manifest Governance Playbook](../../Core/howto/plugin-manifest-governance.md).
...
3. **Device Manager validation**
   - Load the candidate manifests and refresh the
     [Device Manager compatibility dashboard](../../Core/howto/device-manager-compatibility-dashboard.md).
