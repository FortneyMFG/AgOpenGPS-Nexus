...
operation.【F:docs/howto/windows-packaging.md†L14-L58】
...
2. For the ZIP path, stop Nexus, back up the previous folder, and extract the new
   ...
   starts.【F:docs/howto/windows-packaging.md†L14-L58】
3. For the installer bundle, extract `AgOpenGPS.Nexus-win-x64-installer.zip`, run
   ...
   Start Menu shortcuts.【F:docs/howto/windows-packaging.md†L41-L58】
...
the offline-first requirements captured in the SRS.【F:docs/SRS/sections/14_Offline_First_Updates.md†L1-L33】
...
stay predictable.【F:docs/SRS/sections/14_Offline_First_Updates.md†L1-L33】
