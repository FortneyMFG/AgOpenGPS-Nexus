...
- **Reflection services** let remote-only plugins expose verbs without shipping a
  ...
  services.【F:docs/SRS/sections/9X_Frontends_Ops/93_Command_Line_Interface.md†L24-L48】
...
- **Output modes:** Support human-readable, `--json`, and `--ndjson` output to
  ...
  stable.【F:docs/SRS/sections/9X_Frontends_Ops/93_Command_Line_Interface.md†L31-L38】
...
- Ship adapter binaries as part of your plugin archive so single-file CLI builds
  ...
  the plugin manifest already uses for runtime assets.【F:docs/SRS/sections/9X_Frontends_Ops/94_Extensibility_Packaging_Updates.md#packaging-updates--catalog†L1-L60】 Run
