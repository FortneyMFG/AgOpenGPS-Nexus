...
- Documentation and fixtures outline the extended importer coverage, keeping parity
  expectations visible for future contributors.【F:docs/reference/agopengps-v6/porting/LegacyDataIngest.md†L7-L36】【F:Nexus SourceCode/tests/Aog.Core.Tests/Legacy/Data/SampleField/Field.txt†L1-L9】
