...
1. **Initial capture (0–4 hours)** — Regional support staff log requests in the ticketing
   ...
   [installer/update channel guide](../howto/installer-update-channels.md) to confirm the
...
- **Level 3 — Cross-team task force (≤ 72 hours)**: For blocking fleet issues, the release
  ...
  [mesh retention & privacy guide](../howto/mesh-retention-privacy-operations-guide.md) when
