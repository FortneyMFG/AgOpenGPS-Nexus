...
Nexus standardises on .NET 8 across Core, AgIO, plugins, tooling, and the Avalonia UI per [ADR-001](../ADR/ADR-001-dotnet8-runtime.md). This playbook records the enforcement knobs that keep the baseline in place and how to validate them during reviews and CI.
