...
[ADR-041](../SRS/sections/6X_Core_Domain_Services/62-ADR-041%20-%20Job%20Sessions%20Lifecycle.md) and
[ADR-043](../SRS/sections/3X_Data_Storage/31-ADR-043%20-%20Multi-Field%20Job%20Envelopes.md). The Avalonia UI layer now
